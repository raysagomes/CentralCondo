    ...
    return (
        <Container style={{ marginTop: '2rem' }}>
            ...
            <Form onSubmit={handleAddEntity} className="mb-4">
                ...
                <Button type="submit" className="mt-2">Adicionar Entidade</Button>
            </Form>
            ...
            <Form onSubmit={handleAssociate}>
                <Form.Group className="mb-3">
                    ...
                    <Form.Select onChange={e => setSelectedMember(e.target.value)} required>
                ...
                <Form.Group className="mb-3">
                    ...
                    <Form.Select onChange={e => setSelectedEntity(e.target.value)} required>
